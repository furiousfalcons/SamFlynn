...
public class Robot extends TimedRobot {
	...
	public void determineAutonomous() {
		...
		//check if message is null or empty from field data and set char based on answer
		char fieldData;
		if (DriverStation.getInstance().getGameSpecificMessage() != null && !DriverStation.getInstance().getGameSpecificMessage().isEmpty())
